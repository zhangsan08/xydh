...
<div class="serach">
     <el-row type="flex" justify="center">
         <li class="li-tab" v-for="item in x[selectedClass]" :key="item.id"
            ...
            :class="{active:selectedEngine==item.id}"
            >
                    {{item.name}}
            </li>
     </el-row>
    ...
    data() {
        return{
            ...
            [
                ...
                {"id":"1","name":"Acfun","text":"","url":"https://www.acfun.cn/search?keyword="},
                {"id":"2","name":"爱奇艺","text":"","url":"https://so.iqiyi.com/so/q_"},
                {"id":"3","name":"腾讯","text":"","url":"https://v.qq.com/x/search/?q="},
                {"id":"4","name":"优酷","text":"","url":"https://so.youku.com/search_video/q_"},
                {"id":"5","name":"芒果","text":"","url":"https://so.mgtv.com/so?k="},
            ],
            //  音乐
            [
                {"id":"0","name":"网易云音乐","text":"网易云","url":"https://music.163.com/#/search/m/?s="},
                {"id":"1","name":"咪咕音乐","text":"它可以听周杰伦","url":"http://music.taihe.com/search?key="},
                {"id":"2","name":"QQ音乐","text":"","url":"https://y.qq.com/portal/search.html#page=1&searchid=1&remoteplace=txt.yqq.top&t=song&w="},
                
            ],
            //  书籍
            [
                {"id":"0","name":"鸠摩搜书","text":"请直接按回车进入搜索 此输入无效","url":"https://www.jiumodiary.com/"},
