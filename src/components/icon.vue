<template>
    <div class="fa-icon">
        <div v-for="iconclass in icons" :key="iconclass.id">
            <el-row>
                <div class="icon-classname">{{iconclass.className}}</div>
            </el-row>
            <el-row>
    ...
    data() {
        return {
            icons:[
                ...
                {"className":"辅助功能图标",
                "icons": ['american-sign-language-interpreting','asl-interpreting','assistive-listening-systems','audio-description','blind','braille','cc','deaf','deafness','hard-of-hearing','low-vision','question-circle-o','sign-language','signing','tty','universal-access','volume-control-phone','wheelchair','wheelchair-alt',],},
                {"className":"手势图标",
                ...
                {"className":"运输图标",
                "icons": ['ambulance','automobile','bicycle','bus','cab','car','fighter-jet','motorcycle','plane','rocket','ship','space-shuttle','subway','taxi','train','truck','wheelchair','wheelchair-alt',],},
                {"className":"性别图标",
                ...
                {"className":"货币币图标",
                "icons": ['bitcoin','btc','cny','dollar','eur','euro','gbp','gg','gg-circle','ils','inr','jpy','krw','money','rmb','rouble','rub','ruble','rupee','shekel','sheqel','try','turkish-lira','usd','viacoin','won','yen',],},
                {"className":"编辑辑器图标",
